...
public abstract class AuthProvider extends Plugin {
    ...
    public abstract static class Registry {
        ...
        public static void register(final String provider, final AuthProvider p) {
            ...
            if (previous != null) {
                PlayAuthenticate.playAuthLogger().warn("There are multiple AuthProviders registered for key '" + provider + "'");
            }
        }
     ...
     *            The user object
     * @param identity
     *            The user identity returned fro, the save operation in the UserService
     * @param session
     *            The session
     */
